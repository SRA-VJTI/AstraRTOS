...
SOURCE ?=  app/main.c
C_SOURCES = kernel/port/system_init.c drivers/src/mpu.c drivers/src/pwm.c drivers/src/rcc.c drivers/src/uart.c drivers/src/gpio.c drivers/src/adc.c kernel/src/overflow.c kernel/src/task.c kernel/src/mutex.c kernel/src/sem.c kernel/src/heap.c kernel/src/stats.c kernel/src/timer.c kernel/src/queue.c
